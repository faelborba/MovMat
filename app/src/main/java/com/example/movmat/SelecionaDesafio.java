...
public class SelecionaDesafio extends AppCompatActivity {
    ...
    public TextView botaoCalcular, botaoSubtrai, botaoMultiplica, botaoDivide, botaoAleatorio, botaoContar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoCalcular = (TextView) findViewById(R.id.botaoCalcular);
        ...
        botaoCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SelecionaDesafio.this, AtividadeCalcular.class);
